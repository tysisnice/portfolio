...
class PortfolioComponent extends React.Component<IProps> {
  render() {
    return (
      <div>
        <header>
          <nav className="Home" id="navbar">
            <h2 id="my-name">Tyson Hauke</h2>
            <div id="nav-links-container">
              <a className="nav-link" onClick={() => this.scrollTo("welcome-section")}>About</a>
              <a className="nav-link" onClick={() => this.scrollTo("projects")}>Projects</a>
        ...
        <section className="Home" id="projects">
          <h2>Projects and real life apps I've built</h2>
        ...
        <section className="Home" id="contact">
          ...
          <footer className="Home"><p>Thank you for checking out my web page! Please get into contact with me if you are interested in my services. <a href="" target="_blank">Click here for more info about me</a></p></footer>
      </div>
    );
  }
